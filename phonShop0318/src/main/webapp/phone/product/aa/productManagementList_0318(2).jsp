...
.design:hover, .design-2:horizontal {
    background-color: #ffffff;
    color: #d85872;
}

select, .search_input, .design-2 {
...
.search_input input, .pro_insert input {
...
<body>
	<div id="myinput">
		...
		<div class="comp_search">
			<div class="form_wrap">
				<select name="pass_input_type"><br><br><br>
				...
				<div class="pro_insert">
		            <input type="submit" name="pass_insert_value" class="design-2" value="상품 등록" />
		            <a href='#' id="icon2" class="insert_icon"><span class="material-icons">edit</span></a>
        		</div>
			</div>
		</div>
	</div>
