...
<div class="cssmenu2"></div>
   ...
   <h3>상품수정</h3>
	...
	<div class="proStatus">상품 노출/숨김
	<label class="displayStatusBox">
		<input type=radio id="displayStatusBoxY" value="Y" checked >노출</label><label class='design'>
		<input type=radio id="displayStatusBoxN" value="N">숨김
	</label></div>
