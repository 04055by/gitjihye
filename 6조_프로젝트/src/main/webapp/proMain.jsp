...
#icon1 {
    ...
    margin-left: 0px; /* 아이콘과 검색 입력 필드 사이의 간격 조정 */
    margin-left: 0; /* 아이콘과 검색 입력 필드 사이의 간격 조정 */
    margin-top: 0;
}
...
#proMenu-1, #proMenu-2, #proMenu-3, #proMenu-4, #proMenu-5, #proMenu-6, #proMenu-7, #proMenu-8, #proMenu-9 {
   width: auto;
}
...
.proUpd + .proDel {
    margin-left: 0; /* 클래스 A 버튼과 클래스 B 버튼 사이의 왼쪽 여백을 0으로 설정 */
}

.proDel + .proUpd {
    margin-right: 0; /* 클래스 B 버튼과 클래스 A 버튼 사이의 오른쪽 여백을 0으로 설정 */
}
