...
/* 2. 상품코드 */
.depth2_box {
    display: flex; /* 부모 요소를 flex container로 설정합니다. */
    align-items: center; /* 수직 가운데 정렬합니다. */
}

.depth2_box p {
    margin-right: 10px; /* 텍스트와 입력 상자 사이의 간격 조정 */
}

.design-2 input[type="text"],
.design-2 a {
    vertical-align: middle; /* 텍스트 상자와 링크를 수직 가운데 정렬합니다. */
}
	...
	<div class="UpdPart-1">
		...
		<div class="updateBox">
			...
			<ul class="ul">
				...
				<ul>
					<label class='design'> <input type=radio id='_viewY'
						name='_view' value='Y' checked>노출
					</label>
					<label class='design'><input type=radio id='_viewN'
		...
		<ul class="ul2">
			...
			<ul>
				<label class="proCode"> <input type="text" class="design-2"
					value="JELLY-001-001" placeholder="상품코드" style="width: 200px"
					readonly="readonly"> <a href="#none" onclick="#">상품상세페이지</a>
	</div>
	<div class="proDesc">
