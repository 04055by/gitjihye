...
public class ProductDTO {
	...
	public ProductDTO(String productCode, int productDisplayStatus, int productSalePrice, int productInventoryQuantity,
			String productRegistrationDate, String productName, int productSaleCount, int productDiscountStatus,
	...
	public void setProductRegistrationDate(String productRegistrationDate) {
		this.productRegistrationDate = productRegistrationDate;
	}
